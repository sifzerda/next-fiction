...
import dialogueBanner from '../assets/dialoguebanner.png'; // Adjust the path as necessary
    ...
    <Layout>
      ...
      <section className="w-full max-w-screen-xl mx-auto -mt-5 px-0 text-black flex flex-col-reverse md:flex-row gap-4">
        ...
        <div className="flex-1">
          ...
          <hr /> {/* ---------------------------------------------------------*/}
          <h1 id="post-dialogue-comments" className="text-base text-llBlue bg-bootstrapDark p-4">Leave a Comment</h1>
