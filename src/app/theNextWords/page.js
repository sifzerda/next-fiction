...
*/}
      ...
      <section className="w-full max-w-screen-xl mx-auto -mt-5 px-0 text-black flex flex-col-reverse md:flex-row gap-4">
        ...
        <div className="flex-1">
          ...
          <p className="code-left-black">
            <span className='bg-cyan'><i> Lifting an edge of the sheet he pulled it away, exposing the entire body, altogether naked and showing in the candle- light a clay-like yellow. It had, however, broad maculations of bluish black, obviously caused by extravasated blood from contusions. The chest and sides looked as if they had been beaten with a bludgeon. </i></span></p>
          <p className="code-left-black">
          ...
          <p className='italic'> <i>There was no sound when Katherine was struck. There was no blood. It was an optical illusion, he thought. The woman just seemed to melt into the wooden curlicues. </i> </p>
