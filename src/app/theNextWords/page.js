...
import nextWordsBanner from '../assets/nextwordsbanner.png'; // Adjust the path as necessary
  ...
  return (
    <Layout>
      ...
      <div className="bg-transparent border border-black rounded-b-md overflow-hidden w-full max-w-screen-xl mx-auto shadow -mt-8">
        <Image src={nextWordsBanner} alt="story background banner" width={1600} height={400} className="w-full h-auto object-cover" priority />
      </div>
      ...
      <section className="w-full max-w-screen-xl mx-auto -mt-5 px-0 text-black flex flex-col-reverse md:flex-row gap-4">
        ...
        <div className="flex-1">
          ...
          <h5>[10] The Roads Not Travelled</h5>
          ...
          <h5>[11] Me Write Pretty One Day</h5>
          ...
          <h4>Fear:</h4>
          <ul className="bullets">
            <li><span className="bg-hGreen">YES:</span> There was a gunshot. I looked down. There was blood everywhere.  </li>
            <li><span className="bg-hRed">NO:</span> There was a gunshot. I looked down. There was a small mark on my leg, running a thin, but steady trail of blood.  </li>
          </ul>
          ...
          <p>Zombies stare silently with eyes and mouth agape. People, generally, do not.</p>
          ...
          <p>It's not that these are necessarily bad writing or that people don't do this in real life.
            But its over-used, especially in moments it's not realistic.
          </p>
          <div className="custom-box">
            <p>Shaking one's head after thinking something strange;</p>
          </div>
          ...
          <p>The yellow is introspection (bad), the green is concrete description (good). </p>
          ...
          <div className="quote-box">
            ...
            <p>
              <i> Lifting an edge of the sheet he pulled it away, exposing the entire body, altogether naked and showing in the
                ...
                The chest and sides looked as if they had been beaten with a bludgeon. </i></p>
            <p>
              <i> There were dreadful lacerations; the skin was torn in strips and shreds. </i></p>
            <p>
              <i> The coroner moved round to the end of the table and undid a silk handkerchief which had been passed under the chin
                ...
                one garment after another, each of which he held up a moment for inspection. All were torn, and stiff with blood.  </i>
          ...
          <p>What physical things are in the scene? What do they look like or what are they doing? Try describing inanimate objects and things as if they had
            ...
            “a leaf let go and parachuted to the ground.”  This will make it seem less like your protag is the only living, thinking entity in a dead world.</p>

          <h4>(2) Others:</h4>
          <p>
            What are other characters doing? Who can be seen from where the protagonist is standing? What narratives can you create from their behaviour?
            ...
            self-referential bubble of activity;
          </p>
          ...
          <p> <i>There was no sound when Katherine was struck. There was no blood. It was an optical illusion, he thought.
          ...
          <ol>
            <li><span className='bg-hRed'>NEGATIVE PHRASING:</span> &quot;He was not good enough.&quot;<br></br>
              <span className='bg-hGreen'>POSITIVE PHRASING:</span> &quot;&quot;He was inadequate.&quot;</li>
            <li><span className='bg-hRed'>NEGATIVE PHRASING:</span> &quot;His hands were not clean.&quot;<br></br>
              <span className='bg-hGreen'>POSITIVE PHRASING:</span> &quot;His hands were dirty.&quot;</li>
            <li><span className='bg-hRed'>NEGATIVE PHRASING:</span> &quot;Rover was not good.&quot;<br></br>
              <span className='bg-hGreen'>POSITIVE PHRASING:</span> &quot;Rover was bad.&quot;</li>
          </ol>
          ...
          <h5>Dying Metaphors:</h5>
          <p>Metaphors overused to the point of losing evocative imagery, i.e. cliches:</p>
          ...
          <p><u>With Expletives: </u>There were two aeroplanes on the runway.
            <br></br><u>Without Expletives: </u>Two aeroplanes idled on the runway.</p>

          <p><u>With Expletives: </u>The plane began to circle.
            <br></br><u>Without Expletives: </u>The plane circled.</p>

          <h3>18.1.13 	Double Words</h3>
          <p>What is wrong with this paragraph?</p>
          <div className="custom-box">
            <p><i>I went over to her place to see how she was getting on on my way home one evening. Once I got there, the patient
          ...
          <div className="custom-box">
            <p><i>On my way home one evening, I went by her place to see how she was getting on. Once there, the patient gave me a
          ...
          <div className="overflow-x-auto mb-4">
            <table className="min-w-full border border-gray-300 text-sm text-left">
              <thead className="bg-gray-100">
                <tr>
                  <th className="border border-gray-300 px-4 py-2 font-semibold"></th>
                  <th className="border border-gray-300 px-4 py-2 font-semibold">Between Words</th>
                  <th className="border border-gray-300 px-4 py-2 font-semibold">Between Sentences</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <th className="border border-gray-300 px-4 py-2 font-medium">Normal pause</th>
                  <td className="border border-gray-300 px-4 py-2">White space</td>
                  <td className="border border-gray-300 px-4 py-2">Period</td>
                </tr>
                <tr>
                  <th className="border border-gray-300 px-4 py-2 font-medium">Shorter pause</th>
                  <td className="border border-gray-300 px-4 py-2">Hyphen</td>
                  <td className="border border-gray-300 px-4 py-2">Semicolon (or colon)</td>
                </tr>
                <tr>
                  <th className="border border-gray-300 px-4 py-2 font-medium">Longer pause</th>
                  <td className="border border-gray-300 px-4 py-2">Dash</td>
                  <td className="border border-gray-300 px-4 py-2">Paragraph</td>
                </tr>
                <tr>
                  <th className="border border-gray-300 px-4 py-2 font-medium">Normal stress</th>
                  <td className="border border-gray-300 px-4 py-2"></td>
                  <td className="border border-gray-300 px-4 py-2">Normal type (or writing)</td>
                </tr>
                <tr>
                  <th className="border border-gray-300 px-4 py-2 font-medium">Unstressed</th>
                  <td className="border border-gray-300 px-4 py-2"></td>
                  <td className="border border-gray-300 px-4 py-2">Parentheses (or two dashes)</td>
                </tr>
                <tr>
                  <th className="border border-gray-300 px-4 py-2 font-medium">Stressed</th>
                  <td className="border border-gray-300 px-4 py-2"></td>
                  <td className="border border-gray-300 px-4 py-2">Italics (or underlining)</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div className="custom-box">
            <p><i>"I heard the drums coming down the street. Then the fifes and the pipes. Then they came around the corner, all dancing." </i></p>
          </div>
          ...
          <div className="custom-box">
            <p>
              <i>The first domino, the second, then the third, then all of them. </i></p>
          </div>
          ...
          <h5>II.	How Characters are Feeling</h5>
          ...
          <div className="quote-box">
            ...
            <p> <i>“Torey," Lucy said, her voice almost plaintive. I looked over. "This is Pecking, for Pete's sake. It's not like up in the city."</i> </p>
          </div>
          ...
          <div className="p-3 mb-3 rounded bg-gray-100 border border-gray-300 font-rubik shadow-md">
            ...
            <p><span className="bg-hYellow">He had gotten away with everything. I felt a sudden stab of disappointment. That was because I just wanted to see
          ...
          <p><span className="text-red-600">The red text = information 'told';</span></p>
          ...
          <h3>18.3.7 	Take my Word for It</h3>
          ...
          <h4>Metaphor:</h4>
          <div className="custom-box">
            <p><i>My mother and father fought all the time, leaving me to pick up the pieces afterwards.</i></p>
          </div>

          <h4>Literal:</h4>
          <div className="custom-box">
            <p><i>My mother picked up the figurine on the mantel and threw it at my father. It missed and crashed against the wall.
              I got down and began sweeping up the pieces.</i></p>
          </div>
          ...
          <h5>2. Never Split an Infinitive </h5>
          ...
          <h5>3. Never End a Sentence with a Preposition </h5>
          ...
          <h5>4. Contractions aren't allowed in formal writing </h5>
          <p>Maybe this was the case in William Strunk's time, but this rule is becoming more obselete by the day. </p>

          <h5>5. The Passive Voice Is to Be Avoided </h5>
          <div className="custom-box">
            <p><i>"The floors were swept, the beds made, the rooms aired out."</i></p>
          </div>

          <p>Avoid this in favour of:</p>
          <div className="custom-box">
            <p><i>"He swept the floors, made the beds, and aired out the rooms."</i></p>
          </div>
          <p>Passive voice is where the subject of the sentence is acted upon, rather than doing the acting. The above example is passive because
            the doer of the action is not mentioned.</p>
          <p>However, passive voice is fine if <i>"the point of interest is the cleanness of the house and not the identity of the cleaner."</i>
            <FootnoteRef text={`BENJAMIN DREYER,\nDreyer's English.`} /></p>

          <h5>6. Sentence Fragments. They're Bad </h5>
