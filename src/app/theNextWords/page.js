      ...
      <section className="w-full max-w-screen-xl mx-auto -mt-5 px-0 text-black flex flex-col-reverse md:flex-row gap-4">
        ...
        <div className="flex-1">
          ...
          <ol>
            ...
            <li>o	There may be an argument for it where you want to imply that (a) the character is astonishingly comfortable with the present company; 
          ...
          <ol>
            ...
            <li>Take advantage of clothing which suggests a bigger outfit; e.g. if a character is wearing a raincoat, we assume they are also wearing gumboots 
              (or some other waterproof shoe), if a character is wearing a scarf, we assume a long sleeve shirt or jumper. </li>
          </ol>
          ...
          <p className="boldPurple">[10] The Roads Not Travelled</p>
          ...
          <p>Stay away from everything that is fancy or pretty or grandiloquent: "Illumination is required to be extinguished in this premises at the conclusion of business." 
            When you really mean: "Storelights must be put out at the end of the day." 
          ...
          <p>Note that hyperbole may be appropriate for certain dialogue, e.g. teenager-isms, or irony, or misleading information, e.g. ‘Big Brother knows everything.&#39; 
            ...
            character&#39;s heightened mental state, e.g.:</p>
          ...
          <ol>
            ...
            <li><u>NO:</u>I asked if she&#39;d be there. He nodded. That&#39;s when I realised getting an invitation to that party was very important, 
          ...
          <ol>
            ...
            <ol>
              <li>Just another on bombastic laughter: you&#39;re implying what was said was really, extraordinarily funny, so you stand to embarrass yourself if 
          ...
          <div className="custom-box">
            <p className="mb-0"><i>“Did I feel a twinge in my little toe, or didn&#39;t I?” </i> asks every character of Mr. Joyce or of Miss Richardson or M. Proust. . . . 
            ...
            <i>— D. H. LAWRENCE</i><FootnoteRef text="Surgery for the Novel — or a Bomb” (1923), D. H. Lawrence." />
          </div>

          <p>Introspection has utility, however overreliance positions the narrator (who may or may not also be the main character) as an obstacle to the reader&#39;s 
          ...
          <p><u>POV isn't determinative: </u>Introspection is not a curse exclusive to ‘1st person POV&#39;; it can happen with any POV. You can write a 1st person POV 
          ...
          <p><code><i>I sniffed the air. I could detect a faint smell of chemical reagents and traces of something more acrid—chlorine? Instinctively I searched the 
            ...
            piled haphazardly on the other side of the room. I pulled out a bracket to hang up my spacesuit, took hold of the zip- fastener, then let go again. 
            Deterred by the confused idea that I was depriving myself of a shield, I could not bring myself to remove it. Once more I looked round the room. 
            I checked that the door was shut tight and that it had no lock, and after a brief hesitation I dragged some of the heaviest boxes to the doorway. 
            Having built this temporary barricade, I freed myself from my clanking armor in three quick movements. A narrow looking-glass, built into the locker door, 
            reflected part of the room, and out of the corner of my eye I caught sight of something moving. I jumped, but it was only my own reflection.  </i></code>
          ...
          <p className="code-left-black">
            <i><span className='hYellow'>There were a few minutes when I was alone with her in the autopsy room. I felt wild. Absent. Before I could stop myself I was 
              leaning close to her, telling her everything. The words draining out of me as she lay there. </span><span className='cyan-text-span'>Her long damp hair 
          ...
          <p className="code-left-black">
            <i>Our secrets circled madly around the bright white room that morning. <span className='highlight'> Rocking back and forth on my heels as I stood next to her, 
              ...
              eadying myself, letting her pull me back into her world, and I sank down, further and further, until I was completely, utterly under.</span></i></p>
          ...
          <p className="code-left-black">
            ...
            <span className='cyan-text-span'>Once, in Chicago, at a crash site that extended over a whole farm field, he had stepped on something squishy. 
              He thought it was a frog, but it was a child's severed hand, palm up. Another time he had seen a man's charred body, still strapped into the seat, 
              except the seat had been flung into the back yard of a suburban house, where it sat upright next to a portable plastic kiddie swimming pool. 
              And in Dallas he had watched the investigators on the rooftops of the suburban houses, collecting the body parts, putting them in bags . . .  </span></i></p>
          <p className="code-left-black">
            <i> Working on a crash-site team demanded the most extraordinary psychological vigilance, to avoid being overwhelmed by what you saw. 
              But there was never any personal danger, any physical risk. The risk was the risk of nightmares. </i></p>
          ...
          <p className="code-left-black">
            <i><span className='bg-cyan'> The coroner rose from his seat and stood beside the dead man.  </span>    </i></p>
          <p className="code-left-black">
            <span className='bg-cyan'><i> Lifting an edge of the sheet he pulled it away, exposing the entire body, altogether naked and showing in the
               candle- light a clay-like yellow. It had, however, broad maculations of bluish black, obviously caused by extravasated blood from contusions. 
               The chest and sides looked as if they had been beaten with a bludgeon. </i></span></p>
          <p className="code-left-black">
            <span className='bg-cyan'><i> There were dreadful lacerations; the skin was torn in strips and shreds. </i></span></p>
          <p className="code-left-black">
            <span className='bg-cyan'><i> The coroner moved round to the end of the table and undid a silk handkerchief which had been passed under the chin 
              and knotted on the top of the head. When the handkerchief was drawn away it exposed what had been the throat. Some of the jurors who had risen 
              to get a better view repented their curiosity and turned away their faces. Witness Harker went to the open window and leaned out across the sill, 
              faint and sick. Dropping the handkerchief upon the dead man's neck the coroner stepped to an angle of the room and from a pile of clothing produced 
              one garment after another, each of which he held up a moment for inspection. All were torn, and stiff with blood.  </i></span>
          ...
          <p><u>(1) Objects:</u></p>
          <ol>
            <li>What physical things are in the scene? What do they look like or what are they doing? Try describing inanimate objects and things as if they had 
              intention and agency, e.g. “The sun slept behind the hills,” “the river dashed forward and embraced the sea,” “the wind crashed into him,” 
              “a leaf let go and parachuted to the ground.”  This will make it seem less like your protag is the only living, thinking entity in a dead world.</li>
          </ol>

          <p><u>(2) Others:</u></p>
          <ol>
            <li>What are other characters doing? Who can be seen from where the protagonist is standing? What narratives can you create from their behaviour? 
              Try making those other characters active (cause), and making your protagonist reactive (effect) as opposed to your protag acting in an isolated 
              self-referential bubble of activity;</li>
          </ol>

          <p><u>(3) Outsides:</u></p>
          <ol>
            <li>What sensory stimuli is your protagonist aware of? What is coming into your protagonist&#39;s world from ‘outside&#39; and how is it 
              shaping or changing your protagonist&#39;s behaviour or thoughts, or upsetting his/her plans?   </li>
          </ol>
          ...
          <p className="code-left">
            <code><i>The Yala swamp is a huge mass of dense papyrus standing four metres high covering thousands of hectares of soggy ground where the river empties 
              ...
              It hides a number of islands and a small lake they call a 'living museum', because its reedy waters are a last refuge for many fish species. 
              Out there somewhere too is a village of about a thousand people, on an island covering some tens of hectares. The reclusive island inhabitants 
              say they will fight to the death, should invaders get far. No outsider has got deeper in than one kilometre.
            </i></code>
            <FootnoteRef text={`FRED PEARCE,\nThe Landgrabbers (non-fiction).`} />
          </p>
          <p className="code-left">
          ...
          <p>Description should be <u>positive</u>: it tells you what something is like, or how it is, or what happened, i.e. it describes what is actually there. 
          David Carroll
          ...
          <p>In almost every case, you want to use ‘pos&#39; description: just come out and say what something is, is like, or what happened. 
            Use neg description only for necessary effect; i.e. it adds something essential which positive description does not provide. </p>

          <p><i>Example:</i></p>
          <p className='italic'>This is the way the world ends. Not with a bang but a whimper.</p>
          <p>The above neg works because if you remove the neg description, all you have is ‘the world ends with a whimper,&#39; which is vague by itself 
          ...
          <p className='italic'><i>It was an optical illusion, he thought. The woman just seemed to melt into the wooden curlicues.<p>There was no sound when 
            Katherine was struck. There was no blood.</p></i></p>
          <p>In fact, the fixed versions would make a great story opener:</p>
          <p className='italic'> <i>There was no sound when Katherine was struck. There was no blood. It was an optical illusion, he thought. 
            The woman just seemed to melt into the wooden curlicues. </i> </p>

          <p>Likewise, David Carroll
            <FootnoteRef text={`DAVID CARROLL,\nA Manual of Writer's Tricks..`} />
            advises you change negative phrasing to its positive equivalent, and provides some examples:</p>
          ...
          <div className="custom-box">
            <p className="mb-0">“...[S]earch for a way by which your character can set out seeking the desired event, person or information. 
              ...
              along on the way to better story logic.”</p>
            <p></p><i>— Jack Bickham
          ...
          <p className="code-left-black">
            <i>I followed the stream again into the woods and eventually came to the circular pool. There were some new animal tracks in the wet sand, and, 
              ringed by oaks, the place was very beautiful, but still I felt bored. Again I waded into the center of the water and looked up at the sky through the trees. 
          ...
          <p>This is an epistolatory in-story diary entry. Needless to say, real diary entries sound nothing like this, which takes you out of the story. 
            A more believable diary entry would go —</p>
          <p className="code-left-black">
            <i>Poroths went into town today. Had breakfast in the farmhouse. Read Dracula – more annoying than scary. Then I got bored so I went out for 
              a walk into the woods. Found a circular pond and animal tracks in the sand. Rings of oak trees. Very beautiful but lonely. I waded into the 
              pond and did that hand signal thing at the sky again – no idea why. Just felt like it. </i></p>
          <p className="code-left-black">
          ...
          <p className='indent-8 mb-2'><i>I went over to her place to see how she was getting on on my way home one evening. Once I got there, the patient 
            gave me a list of symptoms she had had. Scanning it, I gave her her list back. I didn't think she was suicidal then, but later that evening when I 
            realised it it was too late. At the time, I was merely thinking 'What she is is a time waster.'</i></p>

          <p>It only takes two seconds to restructure the sentences, and reads better for it, e.g.</p>
          <p className='indent-8 mb-2'><i>On my way home one evening, I went by her place to see how she was getting on. Once there, the patient gave me a 
            list of her symptoms. I scanned it and gave it back to her, merely feeling irritated by her wasting my time. Later that evening, I realised she 
            had been suicidal, but by then it was too late.</i></p>
          ...
          <p>Your writing is actually about something meaningful and significant. There is a good story, which is not overshadowed by a loud, 
            grandiose self-important style.</p>

          <p className="boldPurple">(II) Objectivity</p>
          <p>Your writing gets to the nature of things as they are, not as they are not, or could be or should be, or you would wish them to be. 
            Like a historicist, you should prioritize description according to reliability; concrete facts, present-time factual observations, 
            then recollections, and feelings and inferences last.</p>

          <p className="boldPurple"> (III) Originality</p>
          ...
          <div className="custom-box">
            <p className="mb-0">“If words are the flesh, muscle, and bone of prose, punctuation is the breath. In support of the words you&#39;ve carefully selected, 
          ...
          <p>Punctuation: it isn't just for neatness in fiction writing; it affects pacing. A comma will provide a short break in speech or events, 
          ...
          <p>Some basic tips from Burnett and Burnett:
            ...
            “Use shorter sentences for action; longer sentences for reflection or, sometimes, the development of an emotion with sensuous undertones. 
            Anger is usually in staccato style.”</p>
          <p>As a basic rule; if things happen sequentially and/or share no essential causative links, give each subject a separate sentence. 
          ...
          <p className="code-left">
            <code><i>The first domino, the second, then the third, then all of them. </i></code></p>
          <p>Now the sentence structure reflects the events. As soon as the first domino falls, the rest of them are compelled to go down. 
            The sentence matches the causal reality. Similarly, as soon as you start reading the sentence, you are compelled to finish reading the sentence.</p>
          ...
          <p>As I stated about writing voice/style, good writing is invisible. Think of your writing like a window to some parallel universe, 
            ...
            your writing is only a distraction from the world beyond it.</p>
          ...
          <ol>
            <li>Adding a description after lines of dialogue suggests a pause between utterances; this could reflect a hesitance to reply, waning interest in the 
              conversation, the imposition of a more important task, or something else;</li>
            <li>Giving numerous lines of dialogue accompanying behaviour, except for one suggests the line lacking description was said very fast, suggesting anxiety, 
              discomfort, urgency, or prophetic understanding, or intimate empathy, or something else; </li>
          </ol>
          ...
          <p>As an example, you can suggest characters are on the same page (or not) with description of them between dialogue. Most indicators 
            are a matter of common sense, such as:</p>
          <ol>
          ...
          <p className='indent-8 mb-2'> <i>"Our good Mrs. Dudley likes doors, doesn't she? She can certainly” -- and their eyes met -- 
            "get out fast in any direction if she wants to."  </i> 
          <FootnoteRef text={`SHIRLEY JACKSON,\nThe Haunting of Hill House.`} /></p>
          <p>The abrupt eye contact gives a sense not only that the protagonist's interest has been evoked by the latter part of the statement, 
            but also of both characters thinking the same thing, and the possibility startles both of them, and an unspoken sense of unease 
            communicated between the characters.</p>
          ...
          <p>There are two small grammatical errors in the above: (1) starting ‘that and&#39; creates a sentence fragment; (2) ‘make believe&#39; 
            is preceded by ‘a&#39; when it is an abstract noun, not a concrete noun. If you know this character is relatively intelligent, 
          ...
          <div className="custom-box">
            <p><span className='text-red'>Mr. Patch-Withers&#39; laughter surprised us all, including himself.</span> <span className='blue-text-xx'>His face, 
              whose shades we had often labeled, now achieved a new one. </span><span className='red-text-x'>Phineas was very happy; sour and stern 
                Mr. Patch-Withers had been given a good laugh for once, and he had done it! </span><span className='blue-text-xx'>He broke into the charmed, 
                  thoughtless grin of a man fulfilled.</span></p>
            <p><span className='text-blue'>He had gotten away with everything. I felt a sudden stab of disappointment. That was because I just wanted to see 
              some more excitement; that must have been it.</span></p>
            <p><span className='text-blue'><span className='highlight'></span>We left the party,</span><span className='red-text-xy'> both of us feeling fine.</span> 
            <span className='blue-text-xx'>I laughed along with Finny, </span><span className='red-text-x'>my best friend, and also unique, able to get away with anything at all. And not because he was a conniver either; I was sure of that. He got away with everything because of the extraordinary kind of person he was. It was quite a compliment to me, as a matter of fact, to have such a person choose me for his best friend.</span></p>
            <p><span className='text-red'>Finny never left anything alone, not when it was well enough, not when it was perfect. </span>
            <span className='blue-text-xx'><span className='highlight'>“Let&#39;s go jump in the river,” he said under his breath as we went out of the sun porch. </span>
          ...
          <div className="custom-box">
            <p><span className='red-text-x'>Mr. Patch-Withers&#39; laughter surprised us all, including himself. His face, whose shades we had often labeled, 
            ...
            <p><span className='blue-text-xx'>“Let&#39;s go jump in the river,” he said under his breath as we went out of the sun porch. He forced compliance 
          ...
          <p className='indent-8 mb-2'> <i>Sanita looked shattered, utterly exhausted. Her face looked pale against the brightly coloured vest she wore, and her hair, 
          ...
          <p>Here, the unavoidable observation is that the protagonist's girlfriend 'Sanita' is miserable and it's the protagonist's fault, no matter what he thinks. 
            The telling word is 'shattered,' which immediately leaves no room for subjective interpretation. The subsequent sentences ('Her face...') give us 'showing' 
          ...
          <p><u>Example: </u>X believes in abortion, Y does not. They argue. Subsequently, X hangs out with Z, who holds a more mediate position on abortion (sometimes okay, 
          ...
          <p>Sometimes you can break the above rule of invisibility (see: 13.2.5) and deliberately flout good English for a particular effect. See this example 
          ...
          <p className='indent-8 mb-2'> <i>The woods were gone; the road had left the river to climb; the radiator was boiling; the young man looked annoyedly 
          ...
          <p className='indent-8 mb-2'> <i>She didn&#39;t say anything. He was wearing blue jeans, a black leather jacket zipped to his throat, 
          ...
          <p>People tend to interpret the traits onto others which they fear most in themselves; this is a psychological phenomenon called 'projection.' 
            This can direct what details your protagonist notices and/or minimises (i.e. which ones you describe and in what way). </p>
          ...
          <p>If you want to create a sense of alienation from a character, have them describe something without showing it, or, even more blatantly, 
            omit description at the time the thing allegedly occurred, and then have the character assert that it occurred at the time. </p>
          <p>For example, in the Haunting of Hill House, the protagonist asserts that she saw some figurines move in her peripheral vision. 
            However, at the time this allegedly occurred, it was not described, or 'shown' to us. This effects distance between us and the protagonist's POV, 
          ...
          <p>Fiction writing is, obviously, writing about pretend things. Superimposition goes one step further; you're writing pretend things about those pretend things. 
            Basically, you're writing one thing as if it were something else (without actually referring to that other thing).</p>
          <p>One of the advantages of this technique is that it's productive when you have writer's block, or you are distracted by all the other things you really want to 
            write about. It's great for coming up with spontaneous inspired bursts of writing. Here's an example:</p>
          <p>Let's say I want to write a story about a haunted house, but I can't come up with anything. Instead, I'm distracted by thoughts of rainforests. 
            Two very different, seemingly irreconcilable subjects. I can use superimposition to write the haunted house as if it were rainforest, e.g.</p>
          <ol>
            ...
            <li>The inside is dark, the high ceiling curves around like a shadowy canopy, long fingers of shadow stretch over the floor, all the furniture is made of hard, 
              unyielding wood, </li>
          ...
          <p>Note: It's not necessary for the subliminal message to be canon. In the above, the haunted house doesn't literally have anything to do with a rainforest. 
            The point of the comparison is to make the reader feel like your haunted house is different from all the others they've read. 
          ...
          <p><u>Literal:</u></p>
          <p className='indent-8 mb-2'>My mother picked up the figurine on the mantel and threw it at my father. It missed and crashed against the wall. 
            I got down and began sweeping up the pieces.</p>

          <h3>18.3.13 	Breaking Grammar</h3>
          <p>As to writing proscriptions: generally, never say never. Breaking a writing rule is always a choice at the discretion of the writer. 
            There are reasons for, reasons against. You have to be smart enough to know the difference. Dreyer  provides exceptions to a list of common writing rules:
            <FootnoteRef text={`BENJAMIN DREYER,\nDreyer's English.`} /></p>
          ...
          <p>But, start with a conjunction and you may give a sentence a slightly different feeling; maybe humourous, like a punchline, or solemnity; 
            ...
            are different, or the things should be together -- should be expected to be together -- but are not. </p>

          <p className="boldPurple">2. Never Split an Infinitive </p>
          <p>A split infinitive is where an adverb is placed between the 'to' and the verb, e.g. 'To boldly go' (instead of 'to go boldly') or 
            'to casually walk' (instead of 'to walk casually') or 'to gently push' (instead of 'to push gently').</p>
          <p>Sometimes a split infinitive reads better. If it does, go confidently with it.</p>

          <p className="boldPurple">3. Never End a Sentence with a Preposition </p>
          <p>Prepositions are words which create a relationship with a noun, like: as, at, by, for, from, of.</p>
          <p>Generally, ending on a preposition will make your sentence weaker, or sound less literate, but may sound better in exceptional cases, 
            such as to convey bluntness, forwardness, or casualness, e.g. "So where are you from?"</p>

          <p className="boldPurple">4. Contractions aren't allowed in formal writing </p>
          ...
          <p>Sometimes sentence fragments convey something -- abrupt, paramount, solemn, busy -- that would be lost in a properly formed sentence. 
            Here's an example:</p>
          <p className='indent-8 mb-2'>Fog everywhere. Fog up the river, where it flows among green aits and meadows; fog down the river, where it 
            ...
            barges and small boats. Fog in the eyes and throats of ancient Greenwich pensioners, wheezing by the firesides of their wards; fog in the stem and bowl 
            of the afternoon pipe of the wrathful skipper, down in his close cabin; fog cruelly pinching the toes and fingers of his shivering little apprentice boy on deck. 
            Chance people on the bridges peeping over the parapets into a nether sky of fog, with fog all round them, as if they were up in a balloon, 
            and hanging in the misty clouds.
            <FootnoteRef text={`CHARLES DICKENS,\nBleak House.`} /></p>
          ...
          <hr /> {/* ---------------------------------------------------------*/}
          <h1 id="post-next-comments" className="text-base text-llBlue bg-bootstrapDark p-4">Leave a Comment</h1>
        ...
        <div className="flex flex-col gap-4 items-center md:items-start mt-6">
          ...
          <div className="w-full md:w-60 bg-bootstrapDark border border-black text-white flex flex-col items-start justify-center rounded shadow p-4 text-left">
            ...
            <p className="font-source-code-pro text-xs mt-1">This chapter covers general writing advice, tips and criticism.</p>
          </div>
