        ...
        <div className="flex-1">
          ...
          <div className="custom-box">
            ...
            <ol className="numbered">
              ...
              <li><span className="bg-llllBlue">[Protagonist's direction]</span> dreams of fairytale romance in some distant location with prince.</li>
              <li><u>Act 2 right angle:</u> <span className="bg-volt">[New position]</span> Falling in love with monster.</li>
            </ol>

            <h4>Act 3:</h4>
            <ol className="numbered">
              <li><span className="bg-yellow">[Position]</span> Falling in love with monster.</li>
              <li><u>Act 3 right angle:</u> <span className="bg-volt">[New position]</span> Monster is not a monster but prince.</li>
              <li><span className="bg-hRed">[Conclusion]</span> Protagonist ends up where they dreamed of in the first place.</li>
            </ol>
          </div>

          <h5>#2 The Shawshank Redemption:</h5>
          <div className="custom-box">
            <h4>Act 1</h4>
            <ol className="numbered">
            ...
            <h4>Act 3: </h4>
            <ol className="numbered">
              <li><span className="bg-yellow">[Position]</span> Protagonist coping in prison  </li>
              <li><span className="underline">Act 3 right angle:</span> <span className="bg-volt">[New position]</span> Protagonist escapes prison </li>
              <li><span className="bg-hRed">[Conclusion]</span> Protagonist ends up where they should have been in the first place.</li>
            </ol>
          </div>
          ...
          <p>It gets more complicated as the story goes on.</p>
          ...
          <div className="custom-box">
            <h4>Monster in the House</h4>
            <p> Characters are trapped in a confined space with a 'monster' or dangerous entity out to get them.</p>
            <h4>Golden Fleece</h4>
            <p>The 'quest' myth: a hero goes on a journey in search of something, encountering interesting things or people along the way. Normally, by the end, the hero has undergone a personal transformation.</p>
            <h4>Out of the Bottle</h4>
            <p>A wish comes true for the protagonist or they get something akin to magic — for better or worse. Doesn't have to be supernatural (e.g. someone accidentally comes into a fortune). The flipside is the wish ends up being a curse.</p>
            <h4>Dude with a Problem</h4>
            <p>An ordinary guy (or girl) finds himself in extraordinary circumstances.</p>
            <h4>Rites of Passage</h4>
            <p>Involve characters going through traditional milestone events (school, first relationship, wedding, mid-life crisis, etc)</p>
            <h4>Buddy Love</h4>
            <p>Two characters navigating plot problems together. Usually the buddies are opposites or in conflict, but learn to cooperate and appreciate each other.</p>
            <h4>Whydunnit</h4>
            <p>Normally detective stories, an exploration of human nature and the dark side of humanity.</p>
            <h4>The Fool Triumphant</h4>
            <p>Involve an underdog, a 'little, silly, and overlooked man' as protagonist, set against a 'big establishment,'' who in the end is the one made the fool of.</p>
            <h4>Institutionalized</h4>
            <p>Involves a group as the protagonist (or the protagonist's being indivisibly part of a larger group). The group may be a family, or have no relation other than all being in the same circumstances, e.g. colleagues, or soldiers, or mental patients. The group dynamic is often crazy and self-destructive, the themes relate to identity and the danger of herd mentality.</p>
            <h4>Superhero</h4>
            <p>The opposite of 'Dude With A Problem' — here, an extraordinary guy in an ordinary world. The person might be good or bad or just different. They don't have to be supernatural.</p>
          </div>
          ...
          <div className="custom-box">
            ...
            <h4>IV. The Vacation Slide Show</h4>
          ...
          <h4>(1.1) Types of Pursuit</h4>
          <h6>(A) Direct Pursuit</h6>
          ...
          <h4>(1.2) Potential Pitfalls of Pursuit</h4>
          <h6>(A) The Love Interest is the Obstacle</h6>
          ...
          <h6>(B) The Love Interest's will is Overcome</h6>
          ...
          <h4>(2.1) Potential Pitfalls of Revelation</h4>
          <h6>(A) Unlikeable Love Interests</h6>
          ...
          <h5>I. Pursuit</h5>
          <p>The affection is initially unilateral, which is what drives the pursuit. The end goal is the pursuit becoming mutual (the LI reciprocating the affection);</p>
          <h5>II. Revelation</h5>
          ...
          <h5>III. Conspiracy</h5>
          <p>The affection is present initially. The goal is not for the relationship to begin or develop, but to endure. If anything, the relationship may slowly risk eroding or destructing as the story progresses.</p>
