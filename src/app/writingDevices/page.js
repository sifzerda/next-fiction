...
import writingDevicesBanner from '../assets/writingdevices.png'; // Adjust the path as necessary
    ...
    <Layout>
      ...
      <section className="w-full max-w-screen-xl mx-auto -mt-5 px-0 text-black flex flex-col-reverse md:flex-row gap-4">
        ...
        <div className="flex-1">
          ...
          <h2 id="post-general" className="mb-2 font-semibold">20.1: GENERAL</h2>

          <p>GENERAL INFO HERE</p>

          <hr /> {/* ---------------------------------------------------------*/}

          <h2 id="post-offer/promise">20.2: Offer/Promise</h2>
          ...
          <h2 id="post-blocking">20.3: Blocking</h2>
          ...
          <h2 id="post-reincorporation">20.4: Reincorporation</h2>
          ...
          <h2 id="post-raising-the-stakes">20.5: Raising the Stakes</h2>
          ...
          <h2 id="post-what-is-writers-block">20.9: What is Writer's Block?</h2>

          <p>DEFINE WRITER'S BLOCK, SPECULATE ON ORIGIN</p>

          <hr /> {/* ---------------------------------------------------------*/}

          <h2 id="post-imagine-saying-it">20.10: Imagine Saying It</h2>
          ...
          <hr /> {/* ---------------------------------------------------------*/}
          <h1 id="post-wd-comments" className="text-base text-llBlue bg-bootstrapDark p-4">Leave a Comment</h1>
