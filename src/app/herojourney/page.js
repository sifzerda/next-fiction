    ...
    <Layout>
      ...
      <section className="w-full max-w-screen-xl mx-auto -mt-5 px-4 text-black flex flex-col-reverse md:flex-row gap-4">
        ...
        <div className="flex-1">
          ...
          <h3 className="text-base font-semibold text-midBluey mt-4 mb-2">(1.1) The Call to Adventure</h3>
          ...
          <h3 className="text-base font-semibold text-midBluey mt-4 mb-2">(1.2) Refusal of the Call</h3>
          ...
          <h3 className="text-base font-semibold text-midBluey mt-4 mb-2">(1.3) Supernatural Aid</h3>
          ...
          <h3 className="text-base font-semibold text-midBluey mt-4 mb-2">(1.4) The Crossing of the First Threshold</h3>
          ...
          <h3 className="text-base font-semibold text-midBluey mt-4 mb-2">(1.5) The Belly of the Whale</h3>
          ...
          <h3 className="text-base font-semibold text-midBluey mt-4 mb-2">(2.1) The Road of Trials</h3>
          ...
          <h2 id="post-act-ii-initiation" className="mb-2 font-semibold">(2.2) The Meeting with the Goddess</h2>
          ...
          <h2 id="post-act-ii-initiation" className="mb-2 font-semibold">(2.3) Woman as the Temptress</h2>
          ...
          <h2 id="post-act-ii-initiation" className="mb-2 font-semibold">(2.4) Atonement with the Father</h2>
          ...
          <h2 id="post-act-ii-initiation" className="mb-2 font-semibold">(2.5) Apotheosis</h2>
          ...
          <h2 id="post-act-ii-initiation" className="mb-2 font-semibold">(2.6) The Ultimate Boon</h2>
          ...
          <h2 id="post-act-iii-return" className="mb-2 font-semibold">Act III. Return</h2>
          ...
          <h2 id="post-act-ii-initiation" className="mb-2 font-semibold">(3.1) Refusal of the Return</h2>
          ...
          <h2 id="post-act-ii-initiation" className="mb-2 font-semibold">(3.2) The Magic Flight</h2>
          ...
          <h2 id="post-act-ii-initiation" className="mb-2 font-semibold">(3.3) Rescue from Without</h2>
          ...
          <h2 id="post-act-ii-initiation" className="mb-2 font-semibold">(3.4) The Crossing of the Return Threshold</h2>
          ...
          <h2 id="post-act-ii-initiation" className="mb-2 font-semibold">(3.5) Master of the Two Worlds</h2>
          ...
          <h2 id="post-act-ii-initiation" className="mb-2 font-semibold">(3.6)  Freedom to Live</h2>
          ...
          <h2 id="post-summary" className="mb-2 font-semibold">Summary</h2>
          ...
          <hr /> {/* ---------------------------------------------------------*/}
          <h1 id="post-hero-comments" className="text-base text-llBlue bg-bootstrapDark p-4">Leave a Comment</h1>
