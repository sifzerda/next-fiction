    ...
    <Layout>
      ...
      <section className="w-full max-w-screen-xl mx-auto mt-0 px-4 text-black flex gap-4">
        ...
        <div className="flex-1">
          ...
          <h3 id="post-whatisastory" className="mb-2 font-semibold">2.4: Structuring the plot with live issues</h3>
          ...
          <h3 id="post-whatisastory" className="mb-2 font-semibold">2.5: The 'Strange Sandwich'</h3>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="w-36 bg-bootstrapDark border border-black text-llBlue flex flex-col items-start justify-center rounded shadow p-4 text-left">
            ...
            <ol className="font-source-code-pro flex flex-col list-disc list-inside text-xs leading-tight">
              <li className="mb-px">
                <a href="#post-storytelling" className="hover:underline hover:text-white">2.1: Your Story In One Sentence</a>
              </li>
              <li className="mb-px">
                <a href="#post-whatisastory" className="hover:underline hover:text-white">2.2: Ideas</a>
              </li>
              <li className="mb-px">
                <a href="#post-mainelementsofstory" className="hover:underline hover:text-white">2.3: Building the Story from the Premise</a>
              </li>
              <li className="mb-px">
                <a href="#post-josephcampbellmyths" className="hover:underline hover:text-white">2.4: Structuring the plot with live issues</a>
              </li>
              <li className="mb-px">
                <a href="#post-mythsandmisconceptions" className="hover:underline hover:text-white">2.5: The 'Strange Sandwich'</a>
              </li>
            </ol>
          </div>
