    ...
    <Layout>
      ...
      <section className="w-full max-w-screen-xl mx-auto -mt-5 px-4 text-black flex flex-col-reverse md:flex-row gap-4">
        ...
        <div className="flex-1">
          ...
          <p>It&#39;s beginning to look like a &#39;chain&#39; now. You may find less instances of encouragement as you go along — that&#39;s fine. Encouragement winds the characters&#39; up into performing plot-relevant action. If you set it up substantially early on (as you should be) you&#39;ll find it will cover you for the rest of the story.</p>
          ...
          <hr /> {/* ---------------------------------------------------------*/}
          <h1 id="post-premise-comments" className="text-base text-llBlue bg-bootstrapDark p-4">Leave a Comment</h1>
