...
import conflictBanner from '../assets/conflictbanner.jpg'; // Adjust the path as necessary
  ...
  return (
    <Layout>
      ...
      <div className="bg-transparent border border-black rounded-b-md overflow-hidden w-full max-w-screen-xl mx-auto shadow -mt-8">
        <Image src={conflictBanner} alt="story background banner" width={1600} height={400} className="w-full h-auto object-cover" priority />
      </div>
