      ...
      <section className="w-full max-w-screen-xl mx-auto -mt-5 px-0 text-black flex flex-col-reverse md:flex-row gap-4">
        ...
        <div className="flex-1">
          ...
          <ul className="bullets">
            ...
            <li><i>I, Robot </i>
              <FootnoteRef text={`ISAAC ASIMOV,\nI, Robot.`} />
            </li>
            <li><i>I Have No Mouth and I Must Scream </i>
              <FootnoteRef text={`HARLAN ELLISON,\nI Have No Mouth and I Must Scream.`} />
            </li>
            <li><i>Atlas Shrugged </i>
              <FootnoteRef text={`AYN RAND,\nAtlas Shrugged.`} />
            </li>
            <li><i>The Postman Always Rings Twice </i>
              <FootnoteRef text={`JAMES M. CAIN,\nThe Postman Always Rings Twice.`} />
            </li>
            <li><i>The Big Sleep </i>
              <FootnoteRef text={`RAYMOND CHANDLER,\nThe Big Sleep.`} />
            </li>
        ...
        <div className="flex flex-col gap-4 items-center md:items-start mt-6">
          ...
          <div
            ...
            <ol className="font-source-code-pro flex flex-col list-none text-xs leading-tight m-0 p-0 -ml-0">
              <li><a href="#post-purpose-of-a-synopsis" className="hover:underline text-xs hover:text-white">25.1 Purpose of a Synopsis</a></li>
              <li><a href="#post-what-is-a-synopsis" className="hover:underline text-xs hover:text-white">25.2 What Is A Synopsis?</a></li>
              <li><a href="#post-the-value-of-a-synopsis" className="hover:underline text-xs hover:text-white">25.3 The Value of a Synopsis</a></li>
              <li><a href="#post-how-to-write-a-synopsis" className="hover:underline text-xs hover:text-white">25.4 How To Write A Synopsis</a></li>
              <li><a href="#post-what-is-a-logline" className="hover:underline text-xs hover:text-white">25.5 What Is A Logline?</a></li>
              <li><a href="#post-the-purpose-of-a-logline" className="hover:underline text-xs hover:text-white">25.6 The Purpose of a Logline</a></li>
              <li><a href="#post-features-of-a-good-logline" className="hover:underline text-xs hover:text-white">25.7 Features of a Good Logline</a></li>
              <li><a href="#post-loglines-need-causation" className="hover:underline text-xs hover:text-white">25.8 Loglines Need Causation</a></li>
              <li><a href="#post-what-is-an-effective-title" className="hover:underline text-xs hover:text-white">25.9 What is an Effective Title?</a></li>
              <li><a href="#post-tips" className="hover:underline text-xs hover:text-white">25.10 Tips</a></li>
              <li><a href="#post-marketing-comments" className="hover:underline text-xs hover:text-white">Comments</a></li>
            </ol>
          </div>
          ...
          <div
            ...
            <ol className="font-source-code-pro flex flex-col list-disc list-inside text-xs leading-tight m-0 p-0 -ml-0">
              <li className="mb-px"><a href="/themes" className="hover:underline text-xs hover:text-white">Themes</a></li>
              <li className="mb-px"><a href="/scenes" className="hover:underline text-xs hover:text-white">Scenes</a></li>
              <li className="mb-px"><a href="/description" className="hover:underline text-xs hover:text-white">Description</a></li>
            </ol>
          </div>
