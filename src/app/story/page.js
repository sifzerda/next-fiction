    ...
    <Layout>
      ...
      <section className="w-full max-w-screen-xl mx-auto -mt-5 px-4 text-black flex flex-col-reverse md:flex-row gap-4">
        ...
        <div className="flex-1">
          ...
          <p>Throughout your entire planning process you need to bear in mind whether your story is about gain
          ...
          <p>You may have heard of the 'hero's journey' or the typical story structure where the protagonist faces a challenge,
            ...
            <FootnoteRef text={`SETH STEPHENS-DAVIDOWITZ,\nEverybody Lies.`} /></p>
          ...
          <p>The way the myths manifest in stories is manifold: the myths may occur in stories literally or symbolically, overtly or impliedly, and be present in physical or
          ...
          <p>Some genres are equally effective across both mediums, but operate
        ...
        <div className="flex flex-col gap-4 items-center md:items-start mt-6">
          ...
          <div
            id="about-box"
            className="w-full md:w-60 bg-bootstrapDark border border-black text-white flex flex-col items-start justify-center rounded shadow p-4 text-left">
