  ...
  return (
    <aside
      ...
      className={`
        ...
        pt-52  /* mobile top padding */

        sm:pt-4 /* less top padding on sm+ */
        sm:w-52 sm:fixed sm:top-20 sm:left-0  /* fixed below header */
    ...
    >
      <nav className="w-full flex flex-col h-full">
        <h2 className="flex items-center gap-2 text-yellow text-lg font-semibold mb-1 mt-12 sm:text-left">
          <span>Index</span>
        ...
        <div
          ...
          // No drag cursor or select-none needed anymore
        >
