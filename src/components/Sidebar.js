...
function Sidebar() {
  ...
  return (
    <aside
      role="complementary"
      className="w-full bg-bootstrapDark text-llBlue p-4 z-10 flex flex-col items-center gap-4 sm:w-56 sm:h-screen sm:fixed sm:top-0 sm:left-0 sm:items-start sm:pt-28 sm:border-r-2 sm:border-yellow">
